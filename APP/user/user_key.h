...
//#define T_KEY_AUX               T_KEY_20
//#define T_KEY_BT                T_KEY_21
#define T_KEY_DMI               T_KEY_10
#define T_KEY_TV                T_KEY_11
#define T_KEY_MUSIC             T_KEY_12
#define T_KEY_MOVIE             T_KEY_13
#define T_KEY_PLAY_MODE         T_KEY_20
#define T_KEY_3D                T_KEY_21


//#define T_KEY_TEST              T_KEY_22
...
#define K_VOL_DOWN1             (T_KEY_VOL_DOWN1 | T_KEY_SHORT)
#define KU_VOL_DOWN1            (T_KEY_VOL_DOWN1 | T_KEY_SHORT_UP)
#define KL_VOL_DOWN1            (T_KEY_VOL_DOWN1 | T_KEY_LONG)
#define KLU_VOL_DOWN1           (T_KEY_VOL_DOWN1 | T_KEY_LONG_UP)
#define KH_VOL_DOWN1            (T_KEY_VOL_DOWN1 | T_KEY_HOLD)
...
#define K_VOL_UP1               (T_KEY_VOL_UP1 | T_KEY_SHORT)
#define KU_VOL_UP1              (T_KEY_VOL_UP1 | T_KEY_SHORT_UP)
#define KL_VOL_UP1              (T_KEY_VOL_UP1 | T_KEY_LONG)
#define KLU_VOL_UP1             (T_KEY_VOL_UP1 | T_KEY_LONG_UP)
#define KH_VOL_UP1              (T_KEY_VOL_UP1 | T_KEY_HOLD)
...
#define K_AUX               (T_KEY_AUX | T_KEY_SHORT)
#define KU_AUX              (T_KEY_AUX | T_KEY_SHORT_UP)

#define K_BT                (T_KEY_BT | T_KEY_SHORT)
#define KU_BT               (T_KEY_BT | T_KEY_SHORT_UP)

#define KU_PLAY_MODE        (T_KEY_PLAY_MODE | T_KEY_SHORT_UP)
