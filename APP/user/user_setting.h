...
#define PARAM_EQ                8 
#define PARAM_MAIN              9
#define PARAM_TREBLE            10
#define PARAM_BASS              11
#define PARAM_SUB               12

#define PARAM_WORD_STA          13
#define PARAM_DIM               14

#if 0
#define PARAM_WORD_STA          13
#define PARAM_DSP_EQ            14 
#endif
...
#define VOLUME_DEFAULT      16          //音量默认值
...
typedef struct {
    ...
    u8 fm_min;
    u8 fm_hour;
    bool bt_playing_flag;
    //bool bt_sta_change_flag;
   // bool bt_play_flag;
    ...
    s8 TM1629_input;
    //bool dim_adj_flag;
    bool music_play_flag;
    bool mode_switch_flag;
    bool file_change_flag;
    bool input_sta_err_flag;
    u8 input_sta;
#if NPCP215X
    s8  main_vol;
    s8  Trable_vol;
