...
#define SYS_CRY                         CRY_2M//CRY_32K         //系统时钟源选择
...
#define THEME_SELECT                    THEME_NO//THEME_LEDSEG_7PIN
...
#define AUX_CHANNEL_SEL                 CHANNEL_00_03       //选择LINEIN的通道
...
#define IIC_REUSE_SD                    0       //IIC接口是否需要与SD复用
...
#define WKO_OUTPUT_EN                   1           //WKO用于输出。作一般IO口使用。输出高/低分别是通过上拉10K和下拉60K来实现的。
...
#define SOFT_IR_EN                      1           //红外遥控（NEC软解）
 ...
 *****************************************************************************/
#define IIC_IO_SET
#define IIC_DATA_PORT                   2       //P21
#define IIC_DATA                        1
#define IIC_CLK_PORT                    2       //P20
#define IIC_CLK                         0
...
#define IIS_TYPE                        IIS_TAS5711     // IIS器件选择
...
#define EAR_DETECT_INIT()                       //耳机检测

//复用SDCMD检测时不需要定义IS_EAR_IN
#if !SDCMD_REUSE_EARDET
#ifndef EAR_IS_IN
#define EAR_IS_IN()                     0//(!(P2 & BIT(4)))
#endif
#endif
...
#endif
#ifndef IS_LINEIN_IN
#define IS_LINEIN_IN()                  0//(!(P2 & BIT(6)))
#endif
#endif
