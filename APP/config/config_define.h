...
#define CFG_SDK_VERSION                 0x00010100UL    //SDK 版本号：v0.1.1
...
//PORT边沿中断解码红外  //低2ibt表示中断组，高7bit区分IO口。
#define IR_PORT_INT_P01                 0
#define IR_PORT_INT_P06                 1
#define IR_PORT_INT_P34                 2
#define IR_PORT_INT_P07                 3
#define IR_PORT_INT_P20                 (3|(1<<2))
/*****************************************************************************
 * Module    : 显示相关配置选择列表
 *****************************************************************************/
//显示驱动屏选择
...
#define THEME_LEDSEG_24PIN              (DISPLAY_LEDSEG | 0x83)                 //6位米字 数码管
